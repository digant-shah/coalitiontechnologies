	...
	<div class="col-md-4">
		<form action="{{ route('products.create') }}" method="post" class="ajax-form">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="name" name="name" value="{{ old('name') ? old('name') : 'MacBook' }}">
		  ...
		  <div class="form-group">
		    ...
		    <input type="price" class="form-control" id="price" name="price" value="{{ old('price') ? old('price') : 800 }}">
		    <span class="help-block"></span>
		  </div>
